export const dict = {
  ...
  "dialog.provider.litellm.note": "LiteLLM Proxy — OpenAI-compatible gateway for multi-model routing",
  ...
  "activity.idle": "Idle",
  "activity.retry": "Retrying",
  "activity.offline": "Offline",
  "activity.runningCount": "{{ count }} running",
  "activity.waitingCount": "{{ count }} waiting",
  "activity.idleCount": "{{ count }} idle",
  "activity.retryCount": "{{ count }} retrying",
  "activity.offlineCount": "{{ count }} offline",
  "activity.tooltip.title": "Session Activity",
  "activity.tooltip.running": "Running — agent is actively working",
  "activity.tooltip.waiting": "Waiting — needs your input (permission or question)",
  "activity.tooltip.idle": "Idle — not currently running",
  "activity.tooltip.retry": "Retrying — connection issue, will retry",
  "activity.tooltip.offline": "Offline — disconnected",
  ...
  "settings.providers.tag.liteLLM": "LiteLLM",
  "settings.providers.tag.liteLLMProvider": "LiteLLM Proxy",
  ...
  "provider.litellm.title": "LiteLLM Proxy",
  "provider.litellm.edit.title": "Edit LiteLLM Proxy",
