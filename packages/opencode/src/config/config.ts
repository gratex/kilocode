...
} from "@kilocode/kilo-indexing/config" // kilocode_change
import { ObservabilityConfig as KiloObservabilityConfig } from "@/kilocode/observability/config" // kilocode_change
